      ...
      <FadeIn>
        <div className="z-10 mt-20 flex flex-col items-center gap-3 text-center text-foreground">
          <h1 className="w-2/3 text-2xl font-bold lg:text-4xl">
            Rejoins des développeurs qui ont les mêmes ambitions que toi.
          </h1>
          <p className="mt-2 max-w-lg">
            La valeur de l&apos;accès augmente au fur et à mesure que des
            ressources sont ajoutées.
            <strong>N&apos;attends pas, rejoins DevInside.</strong>
          </p>
